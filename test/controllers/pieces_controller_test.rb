...
class PiecesControllerTest < ActionController::TestCase
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post :create, piece: { code: @piece.code, height: @piece.height, length: @piece.length, name: @piece.name, type_id: @piece.type_id, width: @piece.width }
    end
  ...
  test "should update piece" do
    patch :update, id: @piece, piece: { code: @piece.code, height: @piece.height, length: @piece.length, name: @piece.name, type_id: @piece.type_id, width: @piece.width }
    assert_redirected_to piece_path(assigns(:piece))
  end
